...
function clearBadges(): void {
  ...
  // biome-ignore lint/complexity/noForEach: DOM NodeList forEach is appropriate here
...
export class EditCommunicator {
  ...
  #generateDOMTreeString(element: HTMLElement): string {
    ...
    const buildTree = (
      ...
      // biome-ignore lint/complexity/noForEach: DOM children array forEach is appropriate here
